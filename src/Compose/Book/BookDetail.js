                    ...
                    <div className={"bookD"}>
                        <div>
                            <Descriptions title="Book Info" layout="vertical" bordered>
                                <Descriptions.Item label="Author">{info.authorsArray.map((author)=>author + " ")}</Descriptions.Item>
                                <Descriptions.Item label="Title">{info.title}</Descriptions.Item>
                                <Descriptions.Item label="Type">{info.typesArray.map((type)=>type + " ")}</Descriptions.Item>
